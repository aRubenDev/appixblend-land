  ...
  return (
    <section ref={sectionRef} id="work" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      <div ref={headerRef} className="mb-16 flex items-end justify-between">
        <div>
          <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">{t("work.label")}</span>
      ...
      >
        {experimentSpans.map((span, index) => (
          <WorkCard key={index} span={span} index={index} persistHover={index === 0} />
        ))}
      </div>
    </section>
  )
